...
declare var $: any;
@Component({
  selector: 'app-working-hour-distance-report',
  templateUrl: './working-hour-distance-report.component.html',
  styleUrls: ['./working-hour-distance-report.component.scss']
})
export class WorkingHourDistanceReportComponent implements OnInit {
  token: any;
  filterObject:any={
