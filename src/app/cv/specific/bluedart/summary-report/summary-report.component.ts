...
export class SummaryReportComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,private router: Router,private navServices: NavService,private BluedartService:BluedartService,private CrudService: CrudService, private SpinnerService: NgxSpinnerService, private datepipe: DatePipe) {
...
onBtExport_pop1() {
  ...
  exportToCSV_popup(): void {
    ...
    link.setAttribute('download', this.headerName+".csv");
