...
export class TripReportComponent implements OnInit {
  ...
  region: any=[];
  constructor(private router: Router,private navServices: NavService,private CrudService: CrudService, private SpinnerService: NgxSpinnerService, private datepipe: DatePipe, private BluedartService:BluedartService ) { }
 ...
 Grid_table(){
  ...
  if(this.extra){
    ...
    { headerName: "Route Category", field: "RouteCategory", sortable: true, filter: true, floatingFilter: this.floating_filter ,width: 200,  minWidth: 200, maxWidth: 200},  
      ...
      { headerName: "RouteType", field: "routeType", sortable: true, filter: true, floatingFilter: this.floating_filter,width: 120,  minWidth: 120, maxWidth: 120 },
...
dtdcTripReportFilter(){
  ...
  this.BluedartService.bdTripReportFilter(formdata).subscribe((data:any) => {
...
}else{formdata.append('ReportType',eve.value.ReportType);
  }
  if(eve.value.TripId){
...
exportToCSV(): void {
  ...
  const fieldsArray = [
    ...
    "ApiATA","GPSATD","MobileATD","ApiATD","DistanceKm1", "DistanceKm2", "DistanceKm3",
