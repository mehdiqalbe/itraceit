...
export class DelayReportComponent implements OnInit {
  ...
  constructor(private router: Router,private BluedartService:BluedartService, private navServices: NavService, private itraceIt: CrudService, private SpinnerService: NgxSpinnerService, private datepipe: DatePipe) { }
...
adjustGridHeight() {
  ...
  SumbitFilter(){
    ...
    this.BluedartService.networkVehicleDelayReport(formdataCustomer).subscribe((res: any) => {
