...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  constructor(private datepipe: DatePipe,private router: Router,private navServices: NavService,private bluedartServices:BluedartService,private service:CrudService,private SpinnerService: NgxSpinnerService) { }
  ...
  ngAfterViewInit(): void {  // Ensure this method is properly implemented
    ...
    initApiCalls(){
      ...
      this.bluedartServices.specificTripDashboardFilter(formdataCustomer).subscribe((res: any) => {
        ...
        if(res.Status=='success')
        {
          ...
          this.bluedartServices.specificTripDashboard(formdataCustomer).subscribe((res: any) => {
    ...
    onFilterDashboard(val){
      ...
      this.SpinnerService.show('tableSpinner')
      this.bluedartServices.specificTripDashboard(formData).subscribe((res: any) => {
    ...
    actionPopup(id,val){
      ...
      $('#alertPopUp').modal('show');
        ...
        this.bluedartServices.specificTripDashboardDetails(formData).subscribe((res: any) => {
    ...
    linkPopup(val:any){
      ...
      this.bluedartServices.specificTDLink(formData).subscribe((res: any) => {
  ...
  addMarkersAndPolyline1(imei: string, vehicle_no: string) {
    ...
    // requestAnimationFrame(() => {
      for (let i = 0; i < this.trackingData.length; i++) {
        ...
        mark.addListener('click', (event) => this.handleMarkerClick(event, trackingData, vehicle_no, imei,mark));
  ...
  handleMarkerClick(event, trackingData, vehicle_no, imei,marker) {
     console.log(marker,"handleMarkerClick");
    ...
    this.service.addressS(formdataCustomer).subscribe((res: any) => {
      ...
      this.showWindow(trackingData, vehicle_no, address,marker);
  ...
  showWindow(data, vnumber, add,eve) {
    // var add:any
    this.contentsInfo = ''
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////  
     ...
     this.contentsInfo = '<table style="line-height: 16px; border:none !important">' +
      ...
      '</tr>' +
      '<tr style="border:none !important">' + eve.io + '<tr>' +
      '<tr style=" border:none !important">' +
...
if(flag_exist_lock==1 && flag_lock_status_show==0)
{
  ...
  closeTripF(value)
  {
    ...
    // this.bluedartServices.closeTrip(formdataCustomer).subscribe((res: any) => {
  ...
  submitAHT(value){
    ...
    console.log(formdataCustomer);
    // return
    this.bluedartServices.ahtTimeAdd(formdataCustomer).subscribe((res: any) => {
      console.log("close",res);
      alert(res?.message)
      $('#ahtModal').modal('hide');
      this.onFilterDashboard(this.filterValue)
  ...
  onSearchVehicle(searchTerm: any): void {
    ...
    if (searchTerm?.term && searchTerm?.term?.trim().length>=3) {
      ...
      // this.bluedartServices.transhipVehicle(formData).subscribe((res: any) => {
