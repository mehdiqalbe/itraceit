...
export class DocumentWalletComponent implements OnInit {
  ...
  constructor(private navServices: NavService, private modalService: NgbModal, private formBuilder: FormBuilder, private router: Router, private service: TransporterService, private SpinnerService: NgxSpinnerService, private datepipe: DatePipe) { }
  ShipmentNo:any
  currentDateTime:any;
  datetimepicker1:any;
  token: any
