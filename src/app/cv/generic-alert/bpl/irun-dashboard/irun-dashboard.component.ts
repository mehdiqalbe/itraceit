...
import { DtdcModule } from 'src/app/cv/specific/dtdc/dtdc.module';
import { BplService} from 'src/app/cv/generic-alert/bpl/services/bpl.service'
declare var H: any;
...
export class IrunDashboardComponent implements OnInit
{
  ...
  alert_dashboard:any=[];
 /////////////////////////////////////////////////////////////////////////////////////end popup model   ,
 constructor(private navServices: NavService,private itraceIt: BplService, private CrudService: CrudService,private SpinnerService: NgxSpinnerService, private datepipe: DatePipe) { }
...
// 
 ...
 FullData() {
   ...
   this.CrudService.fullDataS().subscribe(data => {
 ...
 /////////////////////////////////trigger function//////////////////////////
 triggerdropdownF() {
   this.CrudService.triggerS().subscribe(data => {
 ...
 ///////////////////////////////summary functions //////////////////////////////
 summarData() {
   this.CrudService.summaryDataS().subscribe(data => {
