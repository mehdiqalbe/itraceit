...
@Component({
  selector: 'app-vehicle-dashboared',
  templateUrl: './vehicle-dashboared.component.html',
  styleUrls: ['./vehicle-dashboared.component.scss'],
})
export class VehicleDashboaredComponent implements OnInit {
  customerList:any=[]
  UserType:any=''
  editDocs: any=[];
  ...
  filterdata() {
    ...
    this.service.vehicladashboaredfilter(formdata).subscribe((res: any) => {
      console.log('vehicle filter popup', res.Data);
  ...
  populateForm(data) {
    ...
    this.editFilter['VehicleType'] = vehicle?.vehicle_type;
    ...
    console.log(this.editFilter.customer,"customer patch value");
