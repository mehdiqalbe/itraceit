...
export class CrudService {
  ...
  table2S(data) {
    let apiurl = "https://api.secutrak.in/dev-app-itraceit_utilization/OriginLevelSummaryReport4";
  ...
  vehicle(value) {
    let apiurl = "https://uat-api.secutrak.in/dev-app-itraceit_utilization/SearchVehiclesList";
  ...
  summaryS_1(data) {
    // let apiurl = " https://api.secutrak.in/dev-app-itraceit/triggerReportSummaryAT";
    let apiurl = "https://uat-api.secutrak.in/dev-app-itraceit_utilization/triggerReportSummaryAT";
    //let apiurl="https://jsonplaceholder.typicode.com/users";
    //let apiurl= 'http://localhost:3000/workZone'
    return this.http.post(apiurl, data);
  }
  filterS_new(data) {
   ...
   let apiurl = "https://uat-api.secutrak.in/dev-app-itraceit_utilization/vehicleUtilizationMaster";
    //let apiurl="https://jsonplaceholder.typicode.com/users";
    //let apiurl= 'http://localhost:3000/workZone'
    return this.http.post(apiurl, data);
  }
  ...
  // }
  table1S_1(data) {
    let apiurl = "https://uat-api.secutrak.in/dev-app-itraceit_utilization/VehicleUtilizationReports";
